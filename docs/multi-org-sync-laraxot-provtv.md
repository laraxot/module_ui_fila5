...
- **Blocco LFS lato server (provtv)**: risolto riscrivendo la storia del repo
  senza tracking LFS (`import module_ui_fila5 without LFS`), eliminando il
  pre-receive hook come blocco strutturale.
