...
type: concept
tags: [filament, blade, components, usage]
created: 2026-07-14
updated: 2026-07-14
qmd: "filament-blade-components-usage-2 utilizzo dei componenti blade di filament"
...
- ❌ `<x-filament::layouts.app>` - Non esiste, utilizzare invece `<x-layouts.app>` di Quaeris
...
- Creare file Blade in `/var/www/html/Quaeris/laravel/Themes/One/resources/views/pages/`
