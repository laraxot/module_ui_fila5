...
<<<<<<< HEAD
description: "Indice unico e organizzato per argomento della documentazione del modulo UI."
module: UI
tags: [ui, documentazione, modulo, laraxot, index]
status: active
...
<<<<<<< HEAD
# UI — indice della documentazione

Indice unico di `Modules/UI/docs/`. File `.md` totali sotto `docs/`: **1030**.
Questo file organizza i link per argomento; non sposta, rinomina ne' cancella nessun file esistente.
...
Sezioni che rispecchiano le sottocartelle tematiche di `docs/` (esclusi i rami storici, vedi sotto).

### Integrazione (`_integration/`)

- [API](./_integration/api.md)
- [Blocks](./_integration/blocks.md)
- [Carousel Slider](./_integration/carousel-slider.md)
- [Chunk](./_integration/chunk.md)
- [Ci](./_integration/ci.md)
- [Custom Firm Fields](./_integration/custom-firm-fields.md)
- [Custom Theme](./_integration/custom-theme.md)
- [EAV](./_integration/eav.md)
- [Effetcts](./_integration/effetcts.md)
- [Filament](./_integration/filament.md)
- [Flip Cards](./_integration/flip-cards.md)
- [Links](./_integration/links.md)
- [Media](./_integration/media.md)
- [Megamenu](./_integration/megamenu.md)
- [Navbar](./_integration/navbar.md)
- [Page Builder](./_integration/page-builder.md)
- [Qrcode](./_integration/qrcode.md)
- [Ratings](./_integration/ratings.md)
- [Tailwind Themes](./_integration/tailwind-themes.md)
- [Theme](./_integration/theme.md)
- [Ubuntu](./_integration/ubuntu.md)
- [Widgets](./_integration/widgets.md)

### Actions (`actions/`)

- [Generic UI Building Blocks](./actions/generic-ui-building-blocks.md)
- [Table Layout Toggle](./actions/table-layout-toggle.md)

### Architettura (`architecture/`)

- [Component Registration](./architecture/component-registration.md)
- [Filament Pages Structure](./architecture/filament-pages-structure.md)
- [Filament Resources Structure](./architecture/filament-resources-structure.md)
...
- [Component Registration](./blade/component-registration.md)
- [Filament Components](./blade/filament-components.md)

### Blocks (`blocks/`)

- [README](./blocks/README.md)
- [Correct Filament Components](./blocks/correct-filament-components.md)
- [Filament Component Integration](./blocks/filament-component-integration.md)
- [Logo](./blocks/logo.md)
- [Navigation](./blocks/navigation.md)
- [User Dropdown](./blocks/user-dropdown.md)

### Bugfix (`bugfix/`)

- [Groupcolumn Architectural Violations](./bugfix/groupcolumn-architectural-violations.md)
- [Groupcolumn Iconcolumn Shows Raw State](./bugfix/groupcolumn-iconcolumn-shows-raw-state.md)
- [Iconcolumn Extends Filament Column](./bugfix/iconcolumn-extends-filament-column.md)
- [Iconcolumn View Path Fix](./bugfix/iconcolumn-view-path-fix.md)

### Charts (`charts/`)

- [Chartjs Datalabels Multiple Labels Complete Guide](./charts/chartjs-datalabels-multiple-labels-complete-guide.md)
- [Chartjs Plugin Datalabels Filament5](./charts/chartjs-plugin-datalabels-filament5.md)
- [Export Strategy](./charts/export-strategy.md)
- [Filament Chart Js Guide](./charts/filament-chart-js-guide.md)
- [Server Side Actions](./charts/server-side-actions.md)
- [Shared Hosting Strategy](./charts/shared-hosting-strategy.md)

### Clean code (`clean-code/`)

- [No Obvious Comments](./clean-code/no-obvious-comments.md)
- [Syntax Error Fixes](./clean-code/syntax-error-fixes.md)
- [Wizard Schema Aration](./clean-code/wizard-schema-aration.md)
- [Wizard Schema Separation](./clean-code/wizard-schema-separation.md)
- [Wizard Steps](./clean-code/wizard-steps.md)

### Componenti (`components/`)

- [README](./components/README.md)
- [Address Field](./components/address-field.md)
- [Blade Component Registration](./components/blade-component-registration.md)
- [Filament Usage](./components/filament-usage.md)
- [Filament](./components/filament.md)
- [File Upload](./components/file-upload.md)
- [Footer](./components/footer.md)
- [Full Calendar](./components/full-calendar.md)
- [Iconstatesplicolumn Improvements](./components/iconstatesplicolumn-improvements.md)
- [Inline Date Picker Component](./components/inline-date-picker-component.md)
- [Inline Date Picker](./components/inline-date-picker.md)
- [Opening Hours Field](./components/opening-hours-field.md)
- [Page Component Migration](./components/page-component-migration.md)
- [Radio Card Selector Component](./components/radio-card-selector-component.md)
- [Radio Collection Component](./components/radio-collection-component.md)
- [Radio Collection Debugging](./components/radio-collection-debugging.md)
- [Radio Collection Fix Summary](./components/radio-collection-fix-summary.md)
- [Radio Collection Fix Sumy](./components/radio-collection-fix-sumy.md)
- [Radio Collection Implementation](./components/radio-collection-implementation.md)
- [Radio Collection Philosophy](./components/radio-collection-philosophy.md)
- [Radio Collection Usage Examples](./components/radio-collection-usage-examples.md)
- [Studio Card Selector Component](./components/studio-card-selector-component.md)
- [Studio Selection Component](./components/studio-selection-component.md)
- [Table Columns](./components/table-columns.md)
- [UI Components](./components/ui-components.md)
- [Full Calendar](./components/ui_components/full-calendar.md)
- [Volt](./components/volt.md)
...
- [Bottlenecks](./development/roadmap/bottlenecks.md)
- [Component System](./development/roadmap/component-system.md)
- [Form Component](./development/roadmap/form-component.md)
- [Form Components](./development/roadmap/form-components.md)
- [Theme System](./development/roadmap/theme-system.md)

### Epics (BMAD) (`epics/`)

- [UI Epics And Stories](./epics/ui-epics-and-stories.md)

### Esempi (`examples/`)

- [Inline Date Picker Usage](./examples/inline-date-picker-usage.md)
- [Table Layout Implementation Example](./examples/table-layout-implementation-example.md)

### Filament (`filament/`)

- [Attach](./filament/actions/attach.md)
- [PDF](./filament/actions/pdf.md)
- [Automatic Translations](./filament/automatic-translations.md)
- [Best Practices](./filament/best-practices.md)
- [Component Icon Support](./filament/component-icon-support.md)
- [Component Methods Compatibility](./filament/component-methods-compatibility.md)
- [Common Errors](./filament/errors/common-errors.md)
- [Dropdown List Item Tag](./filament/errors/dropdown-list-item-tag.md)
- [Static Instance Method Incompatibility](./filament/errors/static-instance-method-incompatibility.md)
- [Filament 4 Components Guide](./filament/filament-4-components-guide.md)
- [Filament 4 Migration Guide](./filament/filament-4-migration-guide.md)
- [Filament 4 Migration Summary](./filament/filament-4-migration-summary.md)
- [Filament 4 Migration Sumy](./filament/filament-4-migration-sumy.md)
- [File Upload Component](./filament/file-upload-component.md)
- [Installation](./filament/installation.md)
- [Label Translation System](./filament/label-translation-system.md)
- [List Records](./filament/list-records.md)
- [Listrecords](./filament/listrecords.md)
- [Modules](./filament/modules.md)
- [Nested Resource](./filament/nested-resource.md)
- [No Label Rule](./filament/no-label-rule.md)
- [Pulse](./filament/pulse.md)
- [Resource](./filament/resource.md)
- [Resources](./filament/resources.md)
- [Theme](./filament/theme.md)
- [Vendor](./filament/vendor.md)
- [Wizard Best Practices](./filament/wizard-best-practices.md)
- [Wizard Step Naming](./filament/wizard-step-naming.md)

### Filament — componenti aggiuntivi (`filament-components/`)

- [File Upload](./filament-components/file-upload.md)
...
- [README](./headroom/README.md)

### HTML2PDF (`html2pdf/`)

- [Advanced](./html2pdf/advanced.md)
- [Index](./html2pdf/index.md)
- [Laravel](./html2pdf/laravel.md)
- [Security](./html2pdf/security.md)
- [Styling](./html2pdf/styling.md)
- [Usage](./html2pdf/usage.md)

### Icone (`icons/`)

- [Icon System](./icons/icon-system.md)

### Layouts (`layouts/`)

- [Master](./layouts/master.md)

### LLM Wiki (`llm-wiki/`)

- [AGENTS](./llm-wiki/AGENTS.md)
- [Concept](./llm-wiki/_templates/concept.md)
- [Entity](./llm-wiki/_templates/entity.md)
- [Source](./llm-wiki/_templates/source.md)
- [Agents](./llm-wiki/agents.md)
- [Index](./llm-wiki/index.md)
- [Log](./llm-wiki/log.md)

### Output generati (`outputs/`)

- [README](./outputs/README.md)

### Prompt (`prompts/`)

- [Enum Select](./prompts/enum-select.md)
- [Geo Map Widget](./prompts/geo-map-widget.md)
- [Map Picker](./prompts/map-picker.md)

### Analisi qualita (`quality-analysis/`)

- [UI Module Quality Report](./quality-analysis/ui-module-quality-report.md)

### Raw (contenuti grezzi importati) (`raw/`)

75 file. Elenco completo con percorsi (raggruppati per sottocartella):

<details><summary>raw/ (2 file)</summary>
...
<details><summary>raw/notes/ (23 file)</summary>

- [API](./raw/notes/api.md)
- [Blocks](./raw/notes/blocks.md)
- [Carousel Slider](./raw/notes/carousel-slider.md)
- [Chunk](./raw/notes/chunk.md)
- [Ci](./raw/notes/ci.md)
- [Custom Firm Fields](./raw/notes/custom-firm-fields.md)
- [Custom Theme](./raw/notes/custom-theme.md)
- [EAV](./raw/notes/eav.md)
- [Effetcts](./raw/notes/effetcts.md)
- [Filament](./raw/notes/filament.md)
- [Flip Cards](./raw/notes/flip-cards.md)
- [Global Search](./raw/notes/global-search.md)
- [Links](./raw/notes/links.md)
- [Media](./raw/notes/media.md)
- [Megamenu](./raw/notes/megamenu.md)
- [Navbar](./raw/notes/navbar.md)
- [Page Builder](./raw/notes/page-builder.md)
- [Qrcode](./raw/notes/qrcode.md)
- [Ratings](./raw/notes/ratings.md)
- [Tailwind Themes](./raw/notes/tailwind-themes.md)
- [Theme](./raw/notes/theme.md)
- [Ubuntu](./raw/notes/ubuntu.md)
- [Widgets](./raw/notes/widgets.md)

</details>

<details><summary>raw/root-import/ (50 file)</summary>

- [API 1](./raw/root-import/api-1.md)
- [API](./raw/root-import/api.md)
- [Blocks 1](./raw/root-import/blocks-1.md)
- [Blocks](./raw/root-import/blocks.md)
- [Carousel Slider 1](./raw/root-import/carousel-slider-1.md)
- [Carousel Slider](./raw/root-import/carousel-slider.md)
- [Changelog 1](./raw/root-import/changelog-1.md)
- [Changelog](./raw/root-import/changelog.md)
- [Chunk 1](./raw/root-import/chunk-1.md)
- [Chunk](./raw/root-import/chunk.md)
- [Ci 1](./raw/root-import/ci-1.md)
- [Ci](./raw/root-import/ci.md)
- [Custom Firm Fields 1](./raw/root-import/custom-firm-fields-1.md)
- [Custom Firm Fields](./raw/root-import/custom-firm-fields.md)
- [Custom Theme 1](./raw/root-import/custom-theme-1.md)
- [Custom Theme](./raw/root-import/custom-theme.md)
- [EAV 1](./raw/root-import/eav-1.md)
- [EAV](./raw/root-import/eav.md)
- [Effetcts 1](./raw/root-import/effetcts-1.md)
- [Effetcts](./raw/root-import/effetcts.md)
- [Filament 1](./raw/root-import/filament-1.md)
- [Filament](./raw/root-import/filament.md)
- [Flip Cards 1](./raw/root-import/flip-cards-1.md)
- [Flip Cards](./raw/root-import/flip-cards.md)
- [Global Search 1](./raw/root-import/global-search-1.md)
- [Global Search](./raw/root-import/global-search.md)
- [Links 1](./raw/root-import/links-1.md)
- [Links](./raw/root-import/links.md)
- [Media 1](./raw/root-import/media-1.md)
- [Media](./raw/root-import/media.md)
- [Megamenu 1](./raw/root-import/megamenu-1.md)
- [Megamenu](./raw/root-import/megamenu.md)
- [Navbar 1](./raw/root-import/navbar-1.md)
- [Navbar](./raw/root-import/navbar.md)
- [Page Builder 1](./raw/root-import/page-builder-1.md)
- [Page Builder](./raw/root-import/page-builder.md)
- [Qrcode 1](./raw/root-import/qrcode-1.md)
- [Qrcode](./raw/root-import/qrcode.md)
- [Ratings 1](./raw/root-import/ratings-1.md)
- [Ratings](./raw/root-import/ratings.md)
- [Tailwind Themes 1](./raw/root-import/tailwind-themes-1.md)
- [Tailwind Themes](./raw/root-import/tailwind-themes.md)
- [Test 1](./raw/root-import/test-1.md)
- [Test](./raw/root-import/test.md)
- [Theme 1](./raw/root-import/theme-1.md)
- [Theme](./raw/root-import/theme.md)
- [Ubuntu 1](./raw/root-import/ubuntu-1.md)
- [Ubuntu](./raw/root-import/ubuntu.md)
- [Widgets 1](./raw/root-import/widgets-1.md)
- [Widgets](./raw/root-import/widgets.md)
...
- [01 Now](./roadmap/01-now.md)
- [02 Goals](./roadmap/02-goals.md)
- [02 Next](./roadmap/02-next.md)
- [03 Later](./roadmap/03-later.md)
- [03 Workstreams](./roadmap/03-workstreams.md)
- [04 Milestones](./roadmap/04-milestones.md)
- [04 Risks](./roadmap/04-risks.md)
- [05 Risks](./roadmap/05-risks.md)
- [2025 Q4 Roadmap](./roadmap/2025-q4-roadmap.md)
- [README](./roadmap/README.md)
- [Bottlenecks](./roadmap/bottlenecks.md)
- [Component System](./roadmap/component-system.md)
- [Current State](./roadmap/current-state.md)
- [Form Component](./roadmap/form-component.md)
- [Form Components](./roadmap/form-components.md)
- [Goals](./roadmap/goals.md)
- [Index](./roadmap/index.md)
- [Later](./roadmap/later.md)
- [Legacy Roadmap](./roadmap/legacy-roadmap.md)
- [Milestones](./roadmap/milestones.md)
- [Next](./roadmap/next.md)
- [Now](./roadmap/now.md)
- [Overview](./roadmap/overview.md)
- [Phases](./roadmap/phases.md)
- [Q4 Roadmap](./roadmap/q4-roadmap.md)
- [Quality](./roadmap/quality.md)
- [Risks](./roadmap/risks.md)
- [Roadmap Q4](./roadmap/roadmap-q4.md)
- [Roadmap](./roadmap/roadmap.md)
- [Theme System](./roadmap/theme-system.md)
- [Vision](./roadmap/vision.md)
- [Workstreams](./roadmap/workstreams.md)

### Screenshot (`screenshots/`)

- [Event Detail Page](./screenshots/event-detail-page.md)

### Standard (`standards/`)

- [README](./standards/README.md)
- [Accessibility](./standards/accessibility.md)
- [Auth Form Standards](./standards/auth-form-standards.md)
- [Form Standards](./standards/form-standards.md)
- [Performance](./standards/performance.md)
- [UI Standards](./standards/ui-standards.md)

### Stories (BMAD) (`stories/`)

- [5.12.merge Markers Regressione C89696dc.story](./stories/5.12.merge-markers-regressione-c89696dc.story.md)
- [5.8.merge Conflict Markers Cleanup.story](./stories/5.8.merge-conflict-markers-cleanup.story.md)
- [7.1.phpstan Filament State Components.story](./stories/7.1.phpstan-filament-state-components.story.md)
- [7.10.phpstan Highest Remaining Contracts.story](./stories/7.10.phpstan-highest-remaining-contracts.story.md)
- [7.11.phpstan Residual Coverage Contracts.story](./stories/7.11.phpstan-residual-coverage-contracts.story.md)
- [7.12.phpstan Concurrent Tail Contracts.story](./stories/7.12.phpstan-concurrent-tail-contracts.story.md)
- [7.2.phpstan Test Bootstrap Security.story](./stories/7.2.phpstan-test-bootstrap-security.story.md)
- [7.3.phpstan Shared Fixture Contracts.story](./stories/7.3.phpstan-shared-fixture-contracts.story.md)
- [7.4.phpstan Business Deep Coverage Contracts.story](./stories/7.4.phpstan-business-deep-coverage-contracts.story.md)
- [7.5.phpstan Attack Close Coverage Contracts.story](./stories/7.5.phpstan-attack-close-coverage-contracts.story.md)
- [7.6.phpstan Final Components Coverage Contracts.story](./stories/7.6.phpstan-final-components-coverage-contracts.story.md)
- [7.7.phpstan Filament Deep Coverage Contracts.story](./stories/7.7.phpstan-filament-deep-coverage-contracts.story.md)
- [7.8.phpstan Filament Schema Coverage Contracts.story](./stories/7.8.phpstan-filament-schema-coverage-contracts.story.md)
- [7.9.phpstan Gap Closer Contracts.story](./stories/7.9.phpstan-gap-closer-contracts.story.md)

### Task (`tasks/`)

- [001 Design System Components](./tasks/001-design-system-components.md)
- [Cleanup Redundant Files](./tasks/cleanup-redundant-files.md)
- [Design System Components](./tasks/design-system-components.md)
- [Filament V5 Alignment](./tasks/filament-v5-alignment.md)
- [Increase Test Coverage](./tasks/increase-test-coverage.md)
- [Refactor Complex Components](./tasks/refactor-complex-components.md)
- [Tasks Index](./tasks/tasks-index.md)
- [UI Cleanup Docs](./tasks/ui-cleanup-docs.md)
- [UI Filament V5](./tasks/ui-filament-v5.md)

### Testing (`testing/`)

- [Pest Testing Guide](./testing/pest-testing-guide.md)

### Temi (`themes/`)

- [README](./themes/README.md)
- [Asset Management](./themes/asset-management.md)
- [Compilation](./themes/compilation.md)
- [Components](./themes/components.md)
- [Optimizations](./themes/optimizations.md)
- [Schemaless Attributes Guide](./themes/schemaless-attributes-guide.md)

### Traduzioni (`translations/`)

- [Lang Service Provider](./translations/lang-service-provider.md)

### Wiki (knowledge base interna) (`wiki/`)

111 file. Elenco completo con percorsi (raggruppati per sottocartella):

<details><summary>wiki/ (9 file)</summary>

- [AGENTS](./wiki/AGENTS.md)
- [README](./wiki/README.md)
- [Agents](./wiki/agents.md)
- [Bmad Method](./wiki/bmad-method.md)
- [Context Compression](./wiki/context-compression.md)
- [Index](./wiki/index.md)
- [Log](./wiki/log.md)
...
<details><summary>wiki/_templates/ (3 file)</summary>

- [Concept](./wiki/_templates/concept.md)
- [Entity](./wiki/_templates/entity.md)
- [Source](./wiki/_templates/source.md)

</details>

<details><summary>wiki/commands/ (2 file)</summary>
...
<details><summary>wiki/concepts/ (32 file)</summary>

- [INDEX](./wiki/concepts/INDEX.md)
- [Auth Register Focus Loss Overlay](./wiki/concepts/auth-register-focus-loss-overlay.md)
- [Block Rendering And Optional Services](./wiki/concepts/block-rendering-and-optional-services.md)
- [Claude Audit Static](./wiki/concepts/claude-audit-static.md)
- [Code Redundancy UI](./wiki/concepts/code-redundancy-ui.md)
- [Context Overflow Prevention](./wiki/concepts/context-overflow-prevention.md)
- [Duplicate Method Bodies](./wiki/concepts/duplicate-method-bodies.md)
- [Enum Select Best Practices](./wiki/concepts/enum-select-best-practices.md)
- [Enum Select Component](./wiki/concepts/enum-select-component.md)
- [Enum Select Contract And False Friends](./wiki/concepts/enum-select-contract-and-false-friends.md)
- [Enum Select Usage](./wiki/concepts/enum-select-usage.md)
- [Enumselect Filament API Collisions](./wiki/concepts/enumselect-filament-api-collisions.md)
- [Filament First Blade Canonical](./wiki/concepts/filament-first-blade-canonical.md)
- [Index](./wiki/concepts/index.md)
- [Method Name Homonyms](./wiki/concepts/method-name-homonyms.md)
- [Model States Module Ownership](./wiki/concepts/model-states-module-ownership.md)
- [Module Filament Component Autoload Rule](./wiki/concepts/module-filament-component-autoload-rule.md)
- [Module Root Uppercase Folders Archive](./wiki/concepts/module-root-uppercase-folders-archive.md)
- [Module Root Uppercase Folders](./wiki/concepts/module-root-uppercase-folders.md)
- [No App Support Queueable Actions](./wiki/concepts/no-app-support-queueable-actions.md)
- [No Services No Support Queueable Actions](./wiki/concepts/no-services-no-support-queueable-actions.md)
- [Organizzativa Money](./wiki/concepts/organizzativa-money.md)
- [PHPSTAN Compliance](./wiki/concepts/phpstan-compliance.md)
- [PHPSTAN Dynamic Array Normalization](./wiki/concepts/phpstan-dynamic-array-normalization.md)
...
- [UI Geo Boundary Contracts](./wiki/concepts/ui-geo-boundary-contracts.md)
- [UI Operating Model](./wiki/concepts/ui-operating-model.md)
- [UI Services Support To Actions](./wiki/concepts/ui-services-support-to-actions.md)
- [Xotbase Inheritance Audit](./wiki/concepts/xotbase-inheritance-audit.md)
- [Xotbasefield No View Rule](./wiki/concepts/xotbasefield-no-view-rule.md)

</details>

<details><summary>wiki/how-to/ (1 file)</summary>

- [Gitmodules Sync Session](./wiki/how-to/gitmodules-sync-session.md)

</details>

<details><summary>wiki/memories/ (3 file)</summary>

- [INDEX](./wiki/memories/INDEX.md)
- [Index](./wiki/memories/index.md)
- [Lang Split UI Claude Audit](./wiki/memories/lang-split-ui-claude-audit.md)

</details>

<details><summary>wiki/overviews/ (1 file)</summary>

- [UI Module](./wiki/overviews/ui-module.md)

</details>

<details><summary>wiki/rules/ (2 file)</summary>
...
<details><summary>wiki/skills/ (2 file)</summary>
...
<details><summary>wiki/sources/ (1 file)</summary>

- [UI Architecture Sources](./wiki/sources/ui-architecture-sources.md)

</details>

<details><summary>wiki/troubleshooting/ (7 file)</summary>

- [Git Merge Conflict Inventory 2026 04 28](./wiki/troubleshooting/git-merge-conflict-inventory-2026-04-28.md)
- [Git Merge Conflict Inventory](./wiki/troubleshooting/git-merge-conflict-inventory.md)
- [Git Push Dual Remote Unrelated](./wiki/troubleshooting/git-push-dual-remote-unrelated.md)
- [Git Push Lfs Missing Objects](./wiki/troubleshooting/git-push-lfs-missing-objects.md)
- [Module Theme Root Hygiene](./wiki/troubleshooting/module-theme-root-hygiene.md)
- [PHPSTAN Fixes 2026 05 06](./wiki/troubleshooting/phpstan-fixes-2026-05-06.md)
- [PHPSTAN Fixes](./wiki/troubleshooting/phpstan-fixes.md)

</details>

<details><summary>wiki/ui/ (48 file)</summary>

- [UI API](./wiki/ui/UI-api.md)
- [UI Blocks](./wiki/ui/UI-blocks.md)
- [UI Carousel Slider](./wiki/ui/UI-carousel-slider.md)
- [UI Chunk](./wiki/ui/UI-chunk.md)
- [UI Ci](./wiki/ui/UI-ci.md)
- [UI Custom Firm Fields](./wiki/ui/UI-custom-firm-fields.md)
- [UI Custom Theme](./wiki/ui/UI-custom-theme.md)
- [UI EAV](./wiki/ui/UI-eav.md)
- [UI Effetcts](./wiki/ui/UI-effetcts.md)
- [UI Filament](./wiki/ui/UI-filament.md)
- [UI Flip Cards](./wiki/ui/UI-flip-cards.md)
- [UI Global Search](./wiki/ui/UI-global-search.md)
- [UI Links](./wiki/ui/UI-links.md)
- [UI Media](./wiki/ui/UI-media.md)
- [UI Megamenu](./wiki/ui/UI-megamenu.md)
- [UI Navbar](./wiki/ui/UI-navbar.md)
- [UI Page Builder](./wiki/ui/UI-page-builder.md)
- [UI Qrcode](./wiki/ui/UI-qrcode.md)
- [UI Ratings](./wiki/ui/UI-ratings.md)
- [UI Tailwind Themes](./wiki/ui/UI-tailwind-themes.md)
- [UI Test](./wiki/ui/UI-test.md)
- [UI Theme](./wiki/ui/UI-theme.md)
- [UI Ubuntu](./wiki/ui/UI-ubuntu.md)
- [UI Widgets](./wiki/ui/UI-widgets.md)
- [UI API](./wiki/ui/ui-api.md)
- [UI Blocks](./wiki/ui/ui-blocks.md)
- [UI Carousel Slider](./wiki/ui/ui-carousel-slider.md)
- [UI Chunk](./wiki/ui/ui-chunk.md)
...
## Documentazione per argomento (file in root di `docs/`)

File `.md` posizionati direttamente in `docs/`, raggruppati per argomento tramite il nome file.

### PHPStan e qualita statica

- [Cyclomatic Complexity Report](./cyclomatic-complexity-report.md)
- [Internal Debate PSR4 Resolution](./internal-debate-psr4-resolution.md)
- [PHPSTAN Compliance Status](./phpstan-compliance-status.md)
- [PHPSTAN Compliance](./phpstan-compliance.md)
- [PHPSTAN Corrections Final](./phpstan-corrections-final.md)
- [PHPSTAN Corrections Gennaio](./phpstan-corrections-gennaio.md)
- [PHPSTAN Corrections January](./phpstan-corrections-january.md)
- [PHPSTAN Corrections Summary](./phpstan-corrections-summary.md)
- [PHPSTAN Corrections Sumy](./phpstan-corrections-sumy.md)
...
- [PHPSTAN Errors Locationselector](./phpstan-errors-locationselector.md)
- [PHPSTAN Errors Roadmap](./phpstan-errors-roadmap.md)
- [PHPSTAN Fixes Conflict D41d8c](./phpstan-fixes-conflict-d41d8c.md)
- [PHPSTAN Fixes Conflict](./phpstan-fixes-conflict.md)
- [PHPSTAN Fixes Gennaio](./phpstan-fixes-gennaio.md)
- [PHPSTAN Fixes November](./phpstan-fixes-november.md)
- [PHPSTAN Fixes Summary](./phpstan-fixes-summary.md)
- [PHPSTAN Fixes Sumy](./phpstan-fixes-sumy.md)
- [PHPSTAN Level 10 Cleanup](./phpstan-level-10-cleanup.md)
- [PHPSTAN Level 10 Compliance](./phpstan-level-10-compliance.md)
- [PHPSTAN Level10 Bugfixes Comprehensive](./phpstan-level10-bugfixes-comprehensive.md)
- [PHPSTAN Namespace Correction](./phpstan-namespace-correction.md)
- [PHPSTAN Patterns](./phpstan-patterns.md)
- [PHPSTAN Property Exists Elimination](./phpstan-property-exists-elimination.md)
- [PHPSTAN Roadmap](./phpstan-roadmap.md)
- [PHPSTAN Status](./phpstan-status.md)
- [PHPSTAN](./phpstan.md)
- [PSR4 Autoloading Error Analysis](./psr4-autoloading-error-analysis.md)
- [PSR4 Fix Implementation Plan](./psr4-fix-implementation-plan.md)
- [PSR4 Namespace Violations](./psr4-namespace-violations.md)
- [Strict Types Implementation](./strict-types-implementation.md)
- [Task Ridurre PHPSTAN Suppressioni](./task-ridurre-phpstan-suppressioni.md)

### Filament (componenti, colonne, azioni)

- [Filament 4x Upgrade Report](./filament-4x-upgrade-report.md)
- [Filament 4x Upgrade](./filament-4x-upgrade.md)
- [Filament 5x Compatibility](./filament-5x-compatibility.md)
- [Filament Components Location Studio](./filament-components-location-studio.md)
- [Filament Custom Columns Relationship Resolution](./filament-custom-columns-relationship-resolution.md)
- [Filament Dropdown Avatar Components](./filament-dropdown-avatar-components.md)
- [Filament Extension Fixes](./filament-extension-fixes.md)
- [Filament Groupcolumn And Custom Columns](./filament-groupcolumn-and-custom-columns.md)
- [Filament Pages Refactoring](./filament-pages-refactoring.md)
- [Filament Pages Structure](./filament-pages-structure.md)
- [Filament Table Architecture](./filament-table-architecture.md)
- [Filament V4 Theme Upgrade](./filament-v4-theme-upgrade.md)
- [Filament Version](./filament-version.md)
- [Filament Widgets Frontend](./filament-widgets-frontend.md)
- [Filament](./filament.md)
- [Filamentropdown Avatar Components](./filamentropdown-avatar-components.md)
- [Filamentropdown Avatar Usage](./filamentropdown-avatar-usage.md)
- [Form Filament Widgets](./form-filament-widgets.md)
- [Groupcolumn Child Rendering](./groupcolumn-child-rendering.md)
- [Groupcolumn Relationship Resolution Analysis](./groupcolumn-relationship-resolution-analysis.md)
- [Groupcolumn](./groupcolumn.md)
- [Iconstatesplitcolumn Actions Implementation](./iconstatesplitcolumn-actions-implementation.md)
- [Infolist Schema Guidelines](./infolist-schema-guidelines.md)
- [Selectstatecolumn](./selectstatecolumn.md)
- [Vscode Filament Extension](./vscode-filament-extension.md)

### TableLayoutEnum

- [Bugfix Table Layout Action Conflict](./bugfix-table-layout-action-conflict.md)
- [Bugfix Table Layout Toggle Not Working](./bugfix-table-layout-toggle-not-working.md)
- [Table Layout Enum Analysis](./table-layout-enum-analysis.md)
- [Table Layout Enum Complete Guide](./table-layout-enum-complete-guide.md)
- [Table Layout Enum Comprehensive](./table-layout-enum-comprehensive.md)
- [Table Layout Enum Implementation Example](./table-layout-enum-implementation-example.md)
- [UI Table Layout Enum](./ui-table-layout-enum.md)

### Traduzioni e localizzazione

- [Conflict Resolution Translation Files](./conflict-resolution-translation-files.md)
- [Italian Language Corrections](./italian-language-corrections.md)
- [Localization](./localization.md)
- [Opening Hours Rule Localization](./opening-hours-rule-localization.md)
- [Opening Hours Translation Fix](./opening-hours-translation-fix.md)
- [Theme Translation Sync](./theme-translation-sync.md)
- [Theme Widget Translations](./theme-widget-translations.md)
- [Translations Update Renamed](./translations-update-renamed.md)
- [Translations Update](./translations-update.md)
- [Translations](./translations.md)

### Architettura e design system

- [Architecture Patterns](./architecture-patterns.md)
- [Module Icons Design System](./module-icons-design-system.md)
- [Philosophy](./philosophy.md)
- [Test Fix Philosophy](./test-fix-philosophy.md)

### Icone e brand

- [Blade Icons](./blade-icons.md)
- [Bugfix Icons Missing 2025 01 27](./bugfix-icons-missing-2025-01-27.md)
- [Conflict Resolution Iconstatecolumn](./conflict-resolution-iconstatecolumn.md)
- [Icon State Column Business Logic](./icon-state-column-business-logic.md)
- [Icon System](./icon-system.md)
- [Icons](./icons.md)
- [No Svg Hardcoded In Blade](./no-svg-hardcoded-in-blade.md)

### Componenti Blade / form / navigazione

- [Advanced Form Components](./advanced-form-components.md)
- [Blade Components](./blade-components.md)
- [Data Display Components](./data-display-components.md)
- [Full Calendar](./full-calendar.md)
- [Geo Boundary](./geo-boundary.md)
- [Geo Dependency Violation Interactive Map](./geo-dependency-violation-interactive-map.md)
- [Layout Components](./layout-components.md)
- [Map Integration Guide](./map-integration-guide.md)
- [Media](./media.md)
- [Megamenu](./megamenu.md)
- [Navbar](./navbar.md)
- [Navigation](./navigation.md)
- [Qrcode](./qrcode.md)
- [Radio Collection Component](./radio-collection-component.md)

### Testing e conflitti tecnici

- [Awstest Bugfix Undefined Variable](./awstest-bugfix-undefined-variable.md)
- [Bugfix Awstest Undefined Variable](./bugfix-awstest-undefined-variable.md)
- [Case Conflicts](./case-conflicts.md)
- [Conflict Resolution Locationselector](./conflict-resolution-locationselector.md)
- [Conflict Resolution Tablelayoutenum](./conflict-resolution-tablelayoutenum.md)
...
- [Merge Conflict Markers Committed](./merge-conflict-markers-committed.md)
- [Merge Conflicts List](./merge-conflicts-list.md)
- [Notify Quality Gate Resolution 2026 07 28](./notify-quality-gate-resolution-2026-07-28.md)
- [Notify Quality Gate Resolution](./notify-quality-gate-resolution.md)
- [Notify User Git Push Resolution 2026 07 28](./notify-user-git-push-resolution-2026-07-28.md)
- [Notify User Git Push Resolution](./notify-user-git-push-resolution.md)
- [Resolution Conflitti Tablelayouttrait](./resolution-conflitti-tablelayouttrait.md)
- [Risoluzione Conflitti Tablelayouttrait](./risoluzione-conflitti-tablelayouttrait.md)
- [Roadmap Conflict](./roadmap-conflict.md)
- [Rules Testing No Migrate Fresh](./rules-testing-no-migrate-fresh.md)
- [S3test Bugfix Null Errorcode](./s3test-bugfix-null-errorcode.md)
- [S3test Critical Errors Analysis](./s3test-critical-errors-analysis.md)
- [S3test Method Duplication Bugfix](./s3test-method-duplication-bugfix.md)
- [S3test](./s3test.md)
- [Task Test Livewire Components](./task-test-livewire-components.md)
- [Test Conflicts Resolution](./test-conflicts-resolution.md)
- [Test Structure Cleanup](./test-structure-cleanup.md)
- [Test](./test.md)
...
### Qualita, audit, ridondanza

- [Audit Columns Laraxot Compliance](./audit-columns-laraxot-compliance.md)
...
- [Ignore Suppressions Audit](./ignore-suppressions-audit.md)
- [Modularity Optimizations](./modularity-optimizations.md)
- [Optimization Analysis Dry Kiss](./optimization-analysis-dry-kiss.md)
- [Optimization Analysis](./optimization-analysis.md)
- [Optimization Recommendations](./optimization-recommendations.md)
- [Ottimizzazioni Approfondite Modulo UI](./ottimizzazioni-approfondite-modulo-ui.md)
- [Ottimizzazioni Modulo UI](./ottimizzazioni-modulo-ui.md)
...
- [Widget Optimization](./widget-optimization.md)

### Prodotto, roadmap, strategia

- [Consolidation Plan](./consolidation-plan.md)
- [Consolidation Script](./consolidation-script.md)
...
### Naming, regole, convenzioni

- [Dependency Rules](./dependency-rules.md)
- [Development Workflow Rules](./development-workflow-rules.md)
- [Enum Transclass Implementation](./enum-transclass-implementation.md)
...
- [Transclass Rule](./transclass-rule.md)

### Git, sync, notifiche

- [Git Multi Org Sync Handoff](./git-multi-org-sync-handoff.md)
- [Git Push Recovery 2026 07 28](./git-push-recovery-2026-07-28.md)
- [Git Push Recovery](./git-push-recovery.md)
- [Multi Org Sync Laraxot Provtv](./multi-org-sync-laraxot-provtv.md)

### Spatie Media Library / storage
...
- [EAV](./eav.md)
- [Eloquent Isset Vs Property Exists](./eloquent-isset-vs-property-exists.md)
- [Eloquent Properties Isset Vs Property Exists](./eloquent-properties-isset-vs-property-exists.md)
- [ID Column Record Anchor](./id-column-record-anchor.md)
...
- [Task Location Selector](./task-location-selector.md)
...
- [Design Comuni Faq Components](./design-comuni-faq-components.md)
- [Disabled Components](./disabled-components.md)
- [Dry Kiss Analysis 2025 10 15](./dry-kiss-analysis-2025-10-15.md)
- [Dry Kiss Analysis Hall Of Fame](./dry-kiss-analysis-hall-of-fame.md)
- [Effetcts](./effetcts.md)
- [Feedback Components](./feedback-components.md)
- [Filosofia Modulo UI](./filosofia-modulo-ui.md)
- [Folio Volt Best Practices](./folio-volt-best-practices.md)
- [Form Column Parity](./form-column-parity.md)
- [Frontend](./frontend.md)
- [Group Column Fix](./group-column-fix.md)
- [Inlineate Picker](./inlineate-picker.md)
- [Keting Components Implementation](./keting-components-implementation.md)
- [Laravel 13 Upgrade](./laravel-13-upgrade.md)
- [Links](./links.md)
- [Marketing Components Implementation](./marketing-components-implementation.md)
- [Module Analysis Complete](./module-analysis-complete.md)
- [Module Analysis](./module-analysis.md)
- [Module UI](./module-ui.md)
- [On Demand Pattern](./on-demand-pattern.md)
- [Overview Extended](./overview-extended.md)
- [Packages](./packages.md)
- [Phpmd Improvements](./phpmd-improvements.md)
...
- [Theme Build](./theme-build.md)
- [Theme](./theme.md)
- [Troubleshooting](./troubleshooting.md)
- [UI Module](./ui-module.md)
- [UI](./ui.md)
- [Validation Files Multilingua](./validation-files-multilingua.md)
- [Widgets](./widgets.md)

## Storico / da consolidare

Contenuti duplicati, superati o accantonati in cartelle dedicate da audit precedenti. Non sono stati cancellati ne' rinominati: restano collegati qui come debito di consolidamento.

### Indici legacy

- [00-index.md](./00-index.md) — indice storico con contenuti fusi/duplicati da merge automatici pregressi; superato da questo `index.md`.
- [README.md](./README.md) — presenta contenuti fusi da precedenti collisioni case-insensitive (`readme.md`), non riscritto in questo audit.

### archive (93 file)

<details><summary>_integration/archive/ (6 file)</summary>

- [Carousel Slider](./_integration/archive/carousel_slider.md)
- [Custom Firm Fields](./_integration/archive/custom_firm_fields.md)
- [Custom Theme](./_integration/archive/custom_theme.md)
- [Flip Cards](./_integration/archive/flip_cards.md)
- [Page Builder](./_integration/archive/page_builder.md)
- [Tailwind Themes](./_integration/archive/tailwind_themes.md)

</details>

<details><summary>archive/ (82 file)</summary>

- [Advanced Form Components](./archive/advanced_form_components.md)
- [Algolia Docsearch](./archive/algolia_docsearch.md)
- [Architecture Rules](./archive/architecture_rules.md)
- [Auth Pages](./archive/auth_pages.md)
- [Base Components](./archive/base_components.md)
- [Best Practices](./archive/best_practices.md)
- [Blade Data Handling](./archive/blade_data_handling.md)
- [Blocks System](./archive/blocks_system.md)
- [Bugfix Icons Missing 2025 01 27](./archive/bugfix-icons-missing-2025-01-27.md)
- [Bugfix Icons Missing](./archive/bugfix-icons-missing.md)
- [Bugfix Table Layout Action 2025 01 27](./archive/bugfix-table-layout-action-2025-01-27.md)
- [Bugfix Table Layout Action](./archive/bugfix-table-layout-action.md)
- [Chart Components](./archive/chart_components.md)
- [CMS Link](./archive/cms_link.md)
- [CMS Themes Link](./archive/cms_themes_link.md)
- [Components Guide](./archive/components_guide.md)
- [Conflict Resolution Iconstatecolumn](./archive/conflict_resolution_iconstatecolumn.md)
- [Conflict Resolution Locationselector](./archive/conflict_resolution_locationselector.md)
- [Conflict Resolution Tablelayoutenum](./archive/conflict_resolution_tablelayoutenum.md)
- [Conflict Resolution Translation Files](./archive/conflict_resolution_translation_files.md)
- [Convenzioni Naming Campi](./archive/convenzioni_naming_campi.md)
- [Custom 404 Page](./archive/custom_404_page.md)
- [Customizing Your Site](./archive/customizing_your_site.md)
- [Data Display Components](./archive/data_display_components.md)
- [Design System](./archive/design_system.md)
- [Feedback Components](./archive/feedback_components.md)
- [Filament Blade Components Usage](./archive/filament_blade_components_usage.md)
- [Filament Components](./archive/filament_components.md)
- [Filament Components Errors](./archive/filament_components_errors.md)
- [Filament Components Location Studio](./archive/filament_components_location_studio.md)
- [Filament Components Usage](./archive/filament_components_usage.md)
- [Filament Dropdown Avatar Components](./archive/filament_dropdown_avatar_components.md)
- [Filament Dropdown Avatar Usage](./archive/filament_dropdown_avatar_usage.md)
- [Filament Error Fileupload Buttonlabel](./archive/filament_error_fileupload_buttonlabel.md)
- [Filament Error Fileupload Icon](./archive/filament_error_fileupload_icon.md)
- [Filament Error Fileupload Prefixicon](./archive/filament_error_fileupload_prefixicon.md)
- [Filament Fileupload](./archive/filament_fileupload.md)
- [Filament Fileupload Components](./archive/filament_fileupload_components.md)
- [Filament Pages Refactoring](./archive/filament_pages_refactoring.md)
- [Filament Resources Structure](./archive/filament_resources_structure.md)
- [Filament Vscode](./archive/filament_vscode.md)
- [Flags Components](./archive/flags_components.md)
- [Form Components](./archive/form_components.md)
- [Getting Started](./archive/getting_started.md)
- [Iconstatesplitcolumn Actions Implementation](./archive/iconstatesplitcolumn_actions_implementation.md)
- [Iconstatesplitcolumn Implementation](./archive/iconstatesplitcolumn_implementation.md)
- [Inline Date Picker](./archive/inline_date_picker.md)
- [Italian Language Corrections](./archive/italian_language_corrections.md)
- [Lang Link](./archive/lang_link.md)
- [Layout Components](./archive/layout_components.md)
- [Layouts And Themes](./archive/layouts_and_themes.md)
- [MCP Integration](./archive/mcp_integration.md)
- [MCP Server Recommended](./archive/mcp_server_recommended.md)
- [Naming Conventions](./archive/naming_conventions.md)
- [Naming Rules](./archive/naming_rules.md)
- [Navigation Components](./archive/navigation_components.md)
- [Never Use Label Rule](./archive/never_use_label_rule.md)
- [Opening Hours Rule Localization](./archive/opening_hours_rule_localization.md)
- [Opening Hours Translation Fix](./archive/opening_hours_translation_fix.md)
- [Optimization Recommendations](./archive/optimization_recommendations.md)
- [Paths And Assets](./archive/paths_and_assets.md)
- [PHPSTAN Corrections Summary](./archive/phpstan_corrections_summary.md)
- [PHPSTAN Fixes 2025](./archive/phpstan_fixes_2025.md)
- [PHPSTAN Radio Badge Fix](./archive/phpstan_radio_badge_fix.md)
- [Public Resources Management](./archive/public_resources_management.md)
- [Radio Collection Component](./archive/radio_collection_component.md)
- [Selectstatecolumn Confirmation Modal](./archive/selectstatecolumn_confirmation_modal.md)
- [Spatie Media Library Migration](./archive/spatie_media_library_migration.md)
- [State Transitions](./archive/state_transitions.md)
- [Strict Types Implementation](./archive/strict_types_implementation.md)
- [Struttura Themes Folio](./archive/struttura_themes_folio.md)
- [Studio Card Selector Implementation](./archive/studio_card_selector_implementation.md)
- [Table Components](./archive/table_components.md)
- [Table Layout Enum Analysis](./archive/table_layout_enum_analysis.md)
- [Table Layout Enum Implementation Example](./archive/table_layout_enum_implementation_example.md)
- [Table Layout Enum Usage](./archive/table_layout_enum_usage.md)
- [Transclass Rule](./archive/transclass_rule.md)
- [Validation Files Multilingua](./archive/validation_files_multilingua.md)
- [Vscode Filament Extension](./archive/vscode_filament_extension.md)
- [Vscode Filament Plugin](./archive/vscode_filament_plugin.md)
- [Vscode Php Setup](./archive/vscode_php_setup.md)
- [Widget Optimization](./archive/widget_optimization.md)

</details>

<details><summary>components/archive/ (1 file)</summary>

- [Full Calendar](./components/archive/full_calendar.md)

</details>

<details><summary>filament/archive/ (1 file)</summary>

- [ListRecords](./filament/archive/ListRecords.md)

</details>

<details><summary>roadmap/archive/ (3 file)</summary>

- [Component System](./roadmap/archive/component_system.md)
- [Form Component](./roadmap/archive/form_component.md)
- [Theme System](./roadmap/archive/theme_system.md)

</details>

### legacy (13 file)

- [Full Calendar](./components/legacy/full-calendar.md)
- [Full Calendar](./components/legacy/full_calendar.md)
- [Architecture Rules](./legacy/architecture-rules.md)
- [Architecture Rules](./legacy/architecture_rules.md)
- [Bugfix Table Layout Action](./legacy/bugfix-table-layout-action.md)
- [Filament Components Usage](./legacy/filament-components-usage.md)
- [Filament Dropdown Avatar Usage](./legacy/filament_dropdown_avatar_usage.md)
- [Flags Components](./legacy/flags-components.md)
- [MCP Integration](./legacy/mcp-integration.md)
- [Paths And Assets](./legacy/paths-and-assets.md)
- [Legacy Roadmap And Issues](./roadmap/legacy/legacy-roadmap-and-issues.md)
- [Legacy Roadmap Conflict](./roadmap/legacy/legacy-roadmap-conflict.md)
- [Legacy Roadmap](./roadmap/legacy/legacy-roadmap.md)

### prior_cycles (6 file)

- [Component System](./roadmap/prior_cycles/component-system.md)
- [Component System](./roadmap/prior_cycles/component_system.md)
- [Form Component](./roadmap/prior_cycles/form-component.md)
- [Form Component](./roadmap/prior_cycles/form_component.md)
- [Theme System](./roadmap/prior_cycles/theme-system.md)
- [Theme System](./roadmap/prior_cycles/theme_system.md)

### root-md-files (28 file)

- [CHANGELOG](./root-md-files/CHANGELOG.md)
- [API Relocated](./root-md-files/api-relocated.md)
- [API](./root-md-files/api.md)
- [Blocks Relocated](./root-md-files/blocks-relocated.md)
- [Blocks](./root-md-files/blocks.md)
- [Carousel Slider](./root-md-files/carousel-slider.md)
- [Changelog](./root-md-files/changelog.md)
- [Chunk](./root-md-files/chunk.md)
- [Ci](./root-md-files/ci.md)
- [Custom Firm Fields](./root-md-files/custom-firm-fields.md)
- [Custom Theme](./root-md-files/custom-theme.md)
- [EAV](./root-md-files/eav.md)
- [Effetcts](./root-md-files/effetcts.md)
- [Filament](./root-md-files/filament.md)
- [Flip Cards](./root-md-files/flip-cards.md)
- [Global Search](./root-md-files/global-search.md)
- [Links](./root-md-files/links.md)
- [Media](./root-md-files/media.md)
- [Megamenu](./root-md-files/megamenu.md)
- [Navbar](./root-md-files/navbar.md)
- [Page Builder](./root-md-files/page-builder.md)
- [Qrcode](./root-md-files/qrcode.md)
- [Ratings](./root-md-files/ratings.md)
- [Tailwind Themes](./root-md-files/tailwind-themes.md)
- [Test](./root-md-files/test.md)
- [Theme](./root-md-files/theme.md)
- [Ubuntu](./root-md-files/ubuntu.md)
- [Widgets](./root-md-files/widgets.md)

### root-txt-files (46 file)

<details><summary>root-txt-files/ (46 file)</summary>

- [API 1](./root-txt-files/api-1.md)
- [API](./root-txt-files/api.md)
- [Blocks 1](./root-txt-files/blocks-1.md)
- [Blocks](./root-txt-files/blocks.md)
- [Carousel Slider](./root-txt-files/carousel-slider.md)
- [Carousel Slider](./root-txt-files/carousel_slider.md)
- [Chunk 1](./root-txt-files/chunk-1.md)
- [Chunk](./root-txt-files/chunk.md)
- [Ci 1](./root-txt-files/ci-1.md)
- [Ci](./root-txt-files/ci.md)
- [Custom Firm Fields](./root-txt-files/custom-firm-fields.md)
- [Custom Theme](./root-txt-files/custom-theme.md)
- [Custom Firm Fields](./root-txt-files/custom_firm_fields.md)
- [Custom Theme](./root-txt-files/custom_theme.md)
- [EAV 1](./root-txt-files/eav-1.md)
- [EAV](./root-txt-files/eav.md)
- [Effetcts 1](./root-txt-files/effetcts-1.md)
- [Effetcts](./root-txt-files/effetcts.md)
- [Filament 1](./root-txt-files/filament-1.md)
- [Filament](./root-txt-files/filament.md)
- [Flip Cards](./root-txt-files/flip-cards.md)
- [Flip Cards](./root-txt-files/flip_cards.md)
- [Global Search](./root-txt-files/global-search.md)
- [Global Search](./root-txt-files/global_search.md)
- [Links 1](./root-txt-files/links-1.md)
- [Links](./root-txt-files/links.md)
- [Media 1](./root-txt-files/media-1.md)
- [Media](./root-txt-files/media.md)
- [Megamenu 1](./root-txt-files/megamenu-1.md)
- [Megamenu](./root-txt-files/megamenu.md)
- [Navbar 1](./root-txt-files/navbar-1.md)
- [Navbar](./root-txt-files/navbar.md)
- [Page Builder](./root-txt-files/page-builder.md)
- [Page Builder](./root-txt-files/page_builder.md)
- [Qrcode 1](./root-txt-files/qrcode-1.md)
- [Qrcode](./root-txt-files/qrcode.md)
- [Ratings 1](./root-txt-files/ratings-1.md)
- [Ratings](./root-txt-files/ratings.md)
- [Tailwind Themes](./root-txt-files/tailwind-themes.md)
- [Tailwind Themes](./root-txt-files/tailwind_themes.md)
- [Theme 1](./root-txt-files/theme-1.md)
- [Theme](./root-txt-files/theme.md)
- [Ubuntu 1](./root-txt-files/ubuntu-1.md)
- [Ubuntu](./root-txt-files/ubuntu.md)
- [Widgets 1](./root-txt-files/widgets-1.md)
- [Widgets](./root-txt-files/widgets.md)

</details>

### Cluster di file duplicati/varianti in root (77 cluster, 181 file)

Varianti dello stesso argomento nate da collisioni case-insensitive o copie numerate (`-1`, `-2`, ...). Nessun file e' stato toccato: vanno confrontati e uniti manualmente in un'unica pagina canonica.

- **algolia-docsearch**: [algolia-docsearch-1.md](./algolia-docsearch-1.md), [algolia-docsearch.md](./algolia-docsearch.md)
- **architecture**: [ARCHITECTURE_2025.md](./ARCHITECTURE_2025.md), [architecture-.md](./architecture-.md), [architecture-2025.md](./architecture-2025.md), [architecture.md](./architecture.md), [architecture_2025.md](./architecture_2025.md)
- **architecture-rules**: [architecture-rules-1.md](./architecture-rules-1.md), [architecture-rules.md](./architecture-rules.md), [architecture_rules.md](./architecture_rules.md)
- **auth-pages**: [auth-pages.md](./auth-pages.md), [auth_pages.md](./auth_pages.md)
- **best-practices**: [best-practices-1.md](./best-practices-1.md), [best-practices.md](./best-practices.md)
- **blade-data-handling**: [blade-data-handling-1.md](./blade-data-handling-1.md), [blade-data-handling.md](./blade-data-handling.md)
- **blocks-system**: [blocks-system-1.md](./blocks-system-1.md), [blocks-system.md](./blocks-system.md)
- **brands-icons**: [BRANDS_ICONS.md](./BRANDS_ICONS.md), [brands-icons.md](./brands-icons.md), [brands_icons.md](./brands_icons.md)
- **brands-icons-integration**: [BRANDS_ICONS_INTEGRATION.md](./BRANDS_ICONS_INTEGRATION.md), [brands-icons-integration.md](./brands-icons-integration.md), [brands_icons_integration.md](./brands_icons_integration.md)
- **bugfix-icons-missing**: [bugfix-icons-missing-.md](./bugfix-icons-missing-.md), [bugfix-icons-missing.md](./bugfix-icons-missing.md)
- **bugfix-table-layout-action**: [bugfix-table-layout-action-.md](./bugfix-table-layout-action-.md), [bugfix-table-layout-action.md](./bugfix-table-layout-action.md)
- **carousel-slider**: [carousel-slider.md](./carousel-slider.md), [carousel_slider.md](./carousel_slider.md)
- **changelog**: [CHANGELOG.md](./CHANGELOG.md), [changelog.md](./changelog.md)
- **chart-components**: [chart-components-1.md](./chart-components-1.md), [chart-components.md](./chart-components.md)
- **cms-link**: [cms-link-1.md](./cms-link-1.md), [cms-link.md](./cms-link.md)
- **cms-themes-link**: [cms-themes-link-1.md](./cms-themes-link-1.md), [cms-themes-link.md](./cms-themes-link.md)
- **convenzioni-naming-campi**: [convenzioni-naming-campi-1.md](./convenzioni-naming-campi-1.md), [convenzioni-naming-campi.md](./convenzioni-naming-campi.md)
- **custom-404-page**: [custom-404-page-1.md](./custom-404-page-1.md), [custom-404-page.md](./custom-404-page.md)
- **custom-firm-fields**: [custom-firm-fields.md](./custom-firm-fields.md), [custom_firm_fields.md](./custom_firm_fields.md)
- **custom-theme**: [custom-theme.md](./custom-theme.md), [custom_theme.md](./custom_theme.md)
- **customizing-your-site**: [customizing-your-site-1.md](./customizing-your-site-1.md), [customizing-your-site.md](./customizing-your-site.md)
- **design-comuni-implementation**: [DESIGN_COMUNI_IMPLEMENTATION.md](./DESIGN_COMUNI_IMPLEMENTATION.md), [design-comuni-implementation.md](./design-comuni-implementation.md), [design_comuni_implementation.md](./design_comuni_implementation.md)
- **design-system**: [design-system-1.md](./design-system-1.md), [design-system.md](./design-system.md)
- **dry-kiss-analysis**: [dry-kiss-analysis-.md](./dry-kiss-analysis-.md), [dry-kiss-analysis.md](./dry-kiss-analysis.md)
- **filament-blade-components-usage**: [filament-blade-components-usage-1.md](./filament-blade-components-usage-1.md), [filament-blade-components-usage.md](./filament-blade-components-usage.md), [filament_blade_components_usage.md](./filament_blade_components_usage.md)
- **filament-components**: [filament-components-1.md](./filament-components-1.md), [filament-components.md](./filament-components.md)
- **filament-components-errors**: [filament-components-errors-1.md](./filament-components-errors-1.md), [filament-components-errors.md](./filament-components-errors.md)
- **filament-components-usage**: [filament-components-usage-1.md](./filament-components-usage-1.md), [filament-components-usage.md](./filament-components-usage.md), [filament_components_usage.md](./filament_components_usage.md)
- **filament-dropdown-avatar-usage**: [filament-dropdown-avatar-usage-1.md](./filament-dropdown-avatar-usage-1.md), [filament-dropdown-avatar-usage.md](./filament-dropdown-avatar-usage.md), [filament_dropdown_avatar_usage.md](./filament_dropdown_avatar_usage.md)
- **filament-error-fileupload-buttonlabel**: [filament-error-fileupload-buttonlabel-1.md](./filament-error-fileupload-buttonlabel-1.md), [filament-error-fileupload-buttonlabel.md](./filament-error-fileupload-buttonlabel.md)
- **filament-error-fileupload-icon**: [filament-error-fileupload-icon-1.md](./filament-error-fileupload-icon-1.md), [filament-error-fileupload-icon.md](./filament-error-fileupload-icon.md)
- **filament-error-fileupload-prefixicon**: [filament-error-fileupload-prefixicon-1.md](./filament-error-fileupload-prefixicon-1.md), [filament-error-fileupload-prefixicon.md](./filament-error-fileupload-prefixicon.md)
- **filament-fileupload**: [filament-fileupload-1.md](./filament-fileupload-1.md), [filament-fileupload.md](./filament-fileupload.md)
- **filament-fileupload-components**: [filament-fileupload-components-1.md](./filament-fileupload-components-1.md), [filament-fileupload-components.md](./filament-fileupload-components.md)
- **filament-resources-structure**: [filament-resources-structure-1.md](./filament-resources-structure-1.md), [filament-resources-structure.md](./filament-resources-structure.md)
- **filament-vscode**: [filament-vscode-1.md](./filament-vscode-1.md), [filament-vscode.md](./filament-vscode.md)
- **flags-components**: [flags-components-1.md](./flags-components-1.md), [flags-components.md](./flags-components.md), [flags_components.md](./flags_components.md)
- **flip-cards**: [flip-cards.md](./flip-cards.md), [flip_cards.md](./flip_cards.md)
- **form-components**: [form-components-1.md](./form-components-1.md), [form-components.md](./form-components.md)
- **frameworks**: [FRAMEWORKS.md](./FRAMEWORKS.md), [frameworks.md](./frameworks.md)
- **getting-started**: [getting-started-1.md](./getting-started-1.md), [getting-started.md](./getting-started.md)
- **global-search**: [global-search.md](./global-search.md), [global_search.md](./global_search.md)
- **iconstatesplitcolumn-implementation**: [iconstatesplitcolumn-implementation-1.md](./iconstatesplitcolumn-implementation-1.md), [iconstatesplitcolumn-implementation.md](./iconstatesplitcolumn-implementation.md)
- **inline-date-picker**: [inline-date-picker-1.md](./inline-date-picker-1.md), [inline-date-picker.md](./inline-date-picker.md)
- **lang-link**: [lang-link-1.md](./lang-link-1.md), [lang-link.md](./lang-link.md)
- **layouts-and-themes**: [layouts-and-themes-1.md](./layouts-and-themes-1.md), [layouts-and-themes.md](./layouts-and-themes.md)
- **metodi-duplicati-analisi**: [metodi-duplicati-analisi.md](./metodi-duplicati-analisi.md), [metodi_duplicati_analisi.md](./metodi_duplicati_analisi.md)
- **naming-conventions**: [naming-conventions-1.md](./naming-conventions-1.md), [naming-conventions.md](./naming-conventions.md)
- **naming-rules**: [naming-rules-1.md](./naming-rules-1.md), [naming-rules.md](./naming-rules.md)
- **navigation-components**: [navigation-components-1.md](./navigation-components-1.md), [navigation-components.md](./navigation-components.md), [navigation_components.md](./navigation_components.md)
- **page-builder**: [page-builder.md](./page-builder.md), [page_builder.md](./page_builder.md)
- **paths-and-assets**: [paths-and-assets-1.md](./paths-and-assets-1.md), [paths-and-assets.md](./paths-and-assets.md), [paths-and-assets_1.md](./paths-and-assets_1.md), [paths_and_assets.md](./paths_and_assets.md)
- **patterns**: [PATTERNS.md](./PATTERNS.md), [patterns.md](./patterns.md)
- **phpstan-fixes**: [phpstan-fixes-1.md](./phpstan-fixes-1.md), [phpstan-fixes-2.md](./phpstan-fixes-2.md), [phpstan-fixes-2025.md](./phpstan-fixes-2025.md), [phpstan-fixes.md](./phpstan-fixes.md)
- **phpstan-fixes-january**: [phpstan-fixes-january-1.md](./phpstan-fixes-january-1.md), [phpstan-fixes-january.md](./phpstan-fixes-january.md)
- **phpstan-radio-badge-fix**: [phpstan-radio-badge-fix-1.md](./phpstan-radio-badge-fix-1.md), [phpstan-radio-badge-fix.md](./phpstan-radio-badge-fix.md)
- **product-launch-plan**: [PRODUCT_LAUNCH_PLAN.md](./PRODUCT_LAUNCH_PLAN.md), [product-launch-plan.md](./product-launch-plan.md), [product_launch_plan.md](./product_launch_plan.md)
- **product-roadmap**: [PRODUCT_ROADMAP.md](./PRODUCT_ROADMAP.md), [product-roadmap.md](./product-roadmap.md), [product_roadmap.md](./product_roadmap.md)
- **product-strategy**: [PRODUCT_STRATEGY.md](./PRODUCT_STRATEGY.md), [product-strategy.md](./product-strategy.md), [product_strategy.md](./product_strategy.md)
- **public-resources-management**: [public-resources-management-1.md](./public-resources-management-1.md), [public-resources-management.md](./public-resources-management.md), [public_resources_management.md](./public_resources_management.md)
- **quality-report**: [QUALITY_REPORT.md](./QUALITY_REPORT.md), [quality-report.md](./quality-report.md), [quality_report.md](./quality_report.md)
- **redundancy-analysis**: [REDUNDANCY_ANALYSIS.md](./REDUNDANCY_ANALYSIS.md), [redundancy-analysis.md](./redundancy-analysis.md), [redundancy_analysis.md](./redundancy_analysis.md)
- **roadmap**: [roadmap-.md](./roadmap-.md), [roadmap-2025.md](./roadmap-2025.md), [roadmap.md](./roadmap.md)
- **selectstatecolumn-confirmation-modal**: [selectstatecolumn-confirmation-modal-1.md](./selectstatecolumn-confirmation-modal-1.md), [selectstatecolumn-confirmation-modal.md](./selectstatecolumn-confirmation-modal.md)
- **spatie-media-library-migration**: [spatie-media-library-migration-1.md](./spatie-media-library-migration-1.md), [spatie-media-library-migration.md](./spatie-media-library-migration.md)
- **sprint-planning**: [SPRINT_PLANNING.md](./SPRINT_PLANNING.md), [sprint-planning.md](./sprint-planning.md), [sprint_planning.md](./sprint_planning.md)
- **struttura-themes-folio**: [struttura-themes-folio.md](./struttura-themes-folio.md), [struttura_themes_folio.md](./struttura_themes_folio.md)
- **studio-card-selector-implementation**: [studio-card-selector-implementation-1.md](./studio-card-selector-implementation-1.md), [studio-card-selector-implementation.md](./studio-card-selector-implementation.md)
- **svg-icons-automatic-registration**: [SVG_ICONS_AUTOMATIC_REGISTRATION.md](./SVG_ICONS_AUTOMATIC_REGISTRATION.md), [svg-icons-automatic-registration.md](./svg-icons-automatic-registration.md), [svg_icons_automatic_registration.md](./svg_icons_automatic_registration.md)
- **svg-icons-complete**: [SVG_ICONS_COMPLETE.md](./SVG_ICONS_COMPLETE.md), [svg-icons-complete.md](./svg-icons-complete.md), [svg_icons_complete.md](./svg_icons_complete.md)
- **table-components**: [table-components-1.md](./table-components-1.md), [table-components.md](./table-components.md)
- **table-layout-enum-usage**: [table-layout-enum-usage-1.md](./table-layout-enum-usage-1.md), [table-layout-enum-usage.md](./table-layout-enum-usage.md)
- **tailwind-themes**: [tailwind-themes.md](./tailwind-themes.md), [tailwind_themes.md](./tailwind_themes.md)
- **tech-spec**: [TECH_SPEC.md](./TECH_SPEC.md), [tech_spec.md](./tech_spec.md)
- **translations-update-january**: [translations-update-january-2026.md](./translations-update-january-2026.md), [translations-update-january.md](./translations-update-january.md)
- **user-research**: [USER_RESEARCH.md](./USER_RESEARCH.md), [user-research.md](./user-research.md), [user_research.md](./user_research.md)
- **vscode-filament-plugin**: [vscode-filament-plugin-1.md](./vscode-filament-plugin-1.md), [vscode-filament-plugin.md](./vscode-filament-plugin.md)

## Note di manutenzione

- Indice generato/aggiornato il 2026-09-03 tramite audit strutturale (vedi `stories/docs-index-audit.story.md`).
- Nessun file `.md` esistente e' stato spostato, rinominato o cancellato durante questo audit.
- I cluster in 'Storico / da consolidare' sono candidati a una futura fusione manuale (fuori dallo scope di questo task).
=======
