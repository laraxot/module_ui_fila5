...
This is a **self-maintaining knowledge base** for the UI module. AI agents ingest raw documents, synthesize wiki pages, and keep everything organized.
...
**Maintained By:** All AI agents working on UI
