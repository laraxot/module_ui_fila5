...
story: STORY-001
# GRAVE: issue/discussion del modulo — mai base_techplanner / base_<nome progetto> / mono.
...
**Lezione grave:** in un conflitto Git, *entrambe* le parti possono essere sbagliate (`base_project_*` vs `base_<nome progetto>_*`). Non scegliere a caso: `git remote -v` nella cartella del modulo/tema.
