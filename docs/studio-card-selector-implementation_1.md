...
private function getStudiosForLocation(Get $get): Collection
{
    ...
    return \Modules\<nome progetto>dels\Studio::whereHas('address', function($q) use ($cap, $province, $region) {
...
- [Widget Analysis](../<nome progetto>corrente/docs/widgets/find-doctor-widget-studio-step-analysis.md)
